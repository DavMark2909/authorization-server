...
//                .redirectUri("https://oauthdebugger.com/debug")
        ...
        RegisteredClient taskManagementClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("task-management")
                .clientSecret("task-management-secret")
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
        ...
        return new InMemoryRegisteredClientRepository(registeredClient, taskManagementClient);
    }
...
//  next two beans might be skipped if i prefer to use a uriset and node issuer link on my resource server
